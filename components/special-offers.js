      ...
      <tr>
        <td align="left" valign="middle" bgcolor="#FFFFFF">
          <table width="536" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td colspan="4" align="left" valign="top" bgcolor="#FFFFFF" style="padding:10px 10px 10px 25px;"><span class="contentPadding" style="padding:10px 10px 10px 0px;"><span style="font-family:Arial, Helvetica, sans-serif; font-size:22px; font-weight:bold; color:#333333; padding:0px;">Save 20% Off All ${seriesTitle} Products!</span> <br>
