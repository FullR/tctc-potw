function formatGradeRange(gradeRange) {
  if(gradeRange === "prek") return "Grade PreK";
  return `Grades ${gradeRange.toUpperCase()}`;
}
  ...
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="340" align="left" valign="middle" style="padding:4px 4px 0px 0px;">
        <div style="font-family:Tahoma,Arial, Helvetica, sans-serif; font-size:10px; color:#999999;">The Critical Thinking Co.&#8482; Puzzle of the Week: ${formatGradeRange(gradeRange)}</div>
      </td>
